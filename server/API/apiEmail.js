...
exports.leggiSettaggi = function(req, res) {
    ...
    return res.status(200).json({ successo: true, host: obj.host, port: obj.port, secure: obj.secure, user: obj.user, pass: obj.pass });
}
exports.scriviSettaggi = function(req, res) {
    ...
    return res.status(200).json({ successo: true, settaggi: obj });
}